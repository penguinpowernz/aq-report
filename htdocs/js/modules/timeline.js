        ...
        },
        {
            ...
            events: [
                ...
                },
                {
                    ...
                    description: linkifyEntities('<strong>150 terrorists</strong> (75 direct assault, 75 cordon) assault diplomatic compound. Directly orchestrated by Ayman al-Zawahiri for revenge. PRIMARY GOAL: Kidnapping operation for prisoner swaps (Adel al-Shalali, Blind Sheikh, Abu Faraj al-Libi, Aafia Siddiqui). <br/><strong>THE 17-MINUTE DELAY</strong><br/> CIA Chief "Bob" calls 17th February (who sent ~25 terrorists to attack), lies to GRS team claiming waiting for their help. GRS ready to leave 9:48 PM. Fire on villa started ~10:10 PM. GRS finally leaves ~10:05 PM. "Mathematically they would have been there before the fire started." Deaths: Ambassador Chris Stevens (smoke inhalation), Sean Smith. <br/><strong>SEPARATE CIA ANNEX ATTACK</strong><br/> Wasam bin Hamid (opportunist, not Al-Qaeda plan) overhears call about Team Tripoli coming. Quote: "I\'m going to kill all the Americans tonight." Holds Team Tripoli at airport 1:30-5:05 AM. Releases them at 5:05 AM. First mortar hits 5:17 AM (12 minutes later). Deaths: Tyrone Woods, Glen Doherty. <br/><strong>MILITARY RESPONSE FAILURES</strong><br/> DOD not positioned despite Sept 11 being known high-risk date. EUCOM CIF on training mission in Croatia without airplane. Two teams deployed - both to Italy, not Libya. 5:00 AM directive sends nothing to Benghazi. Hillary Clinton changed FAST team four times (uniforms, aircraft, clearances) - all debates unnecessary as General Housi gave blanket authority immediately. Fighter jets never even considered. Obama told SecDef "use all means" then got on plane to Las Vegas to see Beyoncé and Jay-Z. <br/><strong>THE VIDEO LIE</strong><br/> Jake Sullivan (current NSA 2023) created false video narrative. Video came out Spring 2011, translated August 2012. Egypt protest organizers were Benghazi planners (Al-Zawahiri\'s brother, Mokhtar Salem). Video went viral Sept 13 (two days AFTER attack) only because policymakers used it. NSA cut-and-pasted press comment, marked Top Secret SCI. Hillary Clinton emailed daughter stating it was Al-Qaeda in real time. <br/><strong>BOB\'S CONSEQUENCES</strong><br/> Given "most senior award in CIA." Sent back to farm as trainer. Never held accountable.')
                }
            ]
        },
        {
